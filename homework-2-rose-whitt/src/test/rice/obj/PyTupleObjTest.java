...
//public class PyTupleObjTest {
//    private static PyTupleObj<PyIntObj> emptyIntTuple;
//
//    private static PyTupleObj<PyIntObj> nonEmptyIntTuple;
//    private static PyTupleObj<PyIntObj> nonEmptyIntTuple2;
//
//    @BeforeAll
//    static void setUp() {
//        List<PyIntObj> nonEmptyIntVal = Arrays.asList(new PyIntObj(69), new PyIntObj(420));
//        List<PyIntObj> nonEmptyIntVal2 = Arrays.asList(new PyIntObj(69), new PyIntObj(420));
//
//        // create an empty PyTupleObj
//        List<PyIntObj> emptyIntVal = new ArrayList<>();
//        emptyIntTuple = new PyTupleObj<>(emptyIntVal);
//
//        // create non-empty PyTupleObj
//        nonEmptyIntTuple = new PyTupleObj<>(nonEmptyIntVal);
//        nonEmptyIntTuple2 = new PyTupleObj<>(nonEmptyIntVal2);
//
//
//    }
//
...
//        System.out.println(emptyIntTuple.getValue());
//        assertEquals(Collections.emptyList(), emptyIntTuple.getValue());
//    }
//
//    @Test
//    void testToStringEmpty() {
//        assertEquals("()", emptyIntTuple.toString());
//    }
//
//}
package test.rice.obj;
