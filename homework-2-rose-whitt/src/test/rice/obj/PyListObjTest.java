...
//    @BeforeAll
//    static void setUp() {
//        // Create two identical non-empty lists of floats
//        List<PyFloatObj> nonEmptyFloatVal = Arrays.asList(new PyFloatObj(2.3),
//                new PyFloatObj(3.1), new PyFloatObj(6.0));
//        List<PyFloatObj> nonEmptyFloatVal2 = Arrays.asList(new PyFloatObj(2.3),
//                new PyFloatObj(3.1), new PyFloatObj(6.0));
//
//        // Create an empty PyListObj
//        List<PyFloatObj> emptyFloatVal = new ArrayList<>();
//        emptyFloatList = new PyListObj<>(emptyFloatVal);
//
//        // Create two identical non-empty PyListObjs of floats
//        nonEmptyFloatList = new PyListObj<>(nonEmptyFloatVal);
//        nonEmptyFloatList2 = new PyListObj<>(nonEmptyFloatVal2);
//    }
//
//    /**
//     * Tests getValue() on an empty list.
//     */
//    @Test
//    void testGetValue() {
//        assertEquals(Collections.emptyList(), emptyFloatList.getValue());
//    }
//
//    /**
...
//
//    /**
//     * Tests that equals() returns true for two lists containing identical elements.
//     */
//    @Test
...
//
//    /**
//     * Tests that hashCode() returns the same value for two lists containing identical
//     * elements.
//     */
//    @Test
//    void testHashCodeSimple() {
//        assertEquals(nonEmptyFloatList.hashCode(), nonEmptyFloatList2.hashCode());
//    }
//}
package test.rice.obj;
